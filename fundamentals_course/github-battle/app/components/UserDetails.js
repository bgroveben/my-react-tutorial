...
function UserDetails (user) {
  return (
    <div>
      {!!iser.score && <li className="list-group-item"><h3>Score: {user.score}</h3></li>}
      ...
      {user.info.blog && <li className="list-group-item">Blog: <a href={user.info.blog}></a></li>}
    </div>
  )
}

UserDetails.propTpes = {
